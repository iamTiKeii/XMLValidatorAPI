...
exports.Xml9Parser = void 0;
const base_xml_parser_1 = require("../base-xml.parser");
class Xml9Parser extends base_xml_parser_1.BaseXmlParser {
    get loaiHoSo() {
        return 'XML9';
    }
    parse(xmlContent) {
        ...
        if (!this.load(xmlContent))
            return result;
        if (!this.isRoot('CHI_TIEU_DU_LIEU_GIAY_CHUNG_SINH'))
            return result;
...
exports.Xml9Parser = Xml9Parser;
//# sourceMappingURL=xml9.parser.js.map