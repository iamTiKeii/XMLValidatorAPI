...
exports.Xml2Parser = void 0;
const base_xml_parser_1 = require("../base-xml.parser");
class Xml2Parser extends base_xml_parser_1.BaseXmlParser {
    get loaiHoSo() {
        return 'XML2';
    }
    parse(xmlContent) {
        ...
        if (!this.load(xmlContent))
            return result;
        if (!this.isRoot('CHITIEU_CHITIET_THUOC'))
            return result;
...
exports.Xml2Parser = Xml2Parser;
//# sourceMappingURL=xml2.parser.js.map