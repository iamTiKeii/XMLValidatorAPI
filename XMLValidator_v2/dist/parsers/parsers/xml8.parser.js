...
exports.Xml8Parser = void 0;
const base_xml_parser_1 = require("../base-xml.parser");
class Xml8Parser extends base_xml_parser_1.BaseXmlParser {
    get loaiHoSo() {
        return 'XML8';
    }
    parse(xmlContent) {
        ...
        if (!this.load(xmlContent))
            return model;
        if (!this.isRoot('CHI_TIEU_DU_LIEU_TOM_TAT_HO_SO_BENH_AN'))
            return model;
...
exports.Xml8Parser = Xml8Parser;
//# sourceMappingURL=xml8.parser.js.map